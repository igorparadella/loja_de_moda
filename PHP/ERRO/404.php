...
<body class="d-flex flex-column min-vh-100">  <!-- Navbar aqui (igual ao seu) -->
...
<img src="../../IMG/404.png" class="d-block mx-auto" alt="">

  <!-- Rodapé -->
  <footer class="bg-dark text-white text-center py-3">    <div class="container">
